...
const navItems: NavItem[] = [
  ...
  },
  {
    ...
    name: "Interventions",
    subItems: [
      { name: "Demandes d'Intervention", path: "/interventions/requests", pro: false },
      { name: "Ordres de Travail", path: "/interventions/work-orders", pro: false },
      { name: "Comptes Rendus", path: "/interventions/reports", pro: false },
      { name: "Planification", path: "/interventions/planning", pro: false },
    ],
  },
  {
    icon: <TableIcon />,
...
const othersItems: NavItem[] = [
  {
    ...
    name: "Analyses",
    subItems: [
      { name: "Statistiques", path: "/analytics/statistics", pro: false },
      { name: "Rapports", path: "/analytics/reports", pro: false },
      { name: "KPI", path: "/analytics/kpi", pro: false },
    ],
  },
  {
    icon: <PageIcon />,
